...
public class EstudiantesListaIndividualActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estudiantes_lista_individual);

        conn = new ConexionSQLiteHelper(getApplicationContext(), "bd_materias", null, 1);

        codigoInfoTxt = findViewById(R.id.codigoEstudianteInfo);
